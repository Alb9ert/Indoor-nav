...
export const ROOM_TYPE_ALT: Record<RoomType, string[]> = {
  ...
  SEMINAR_ROOM: ["seminar", "classroom", "lecture room", "teaching room", "course room", "training room", "workshop room", "instruction room"],
  GROUP_ROOM: ["group space", "collaboration room", "team room", "project room", "breakout room", "group work", "collaborative space"],
  MEETING_ROOM: ["conference room", "boardroom", "board room", "meeting space", "huddle room", "booking room", "presentation room"],
  LABORATORY: ["lab", "science room", "research room", "experiment room", "testing room", "research lab"],
  AUDITORIUM: ["lecture hall", "theater", "theatre", "assembly hall", "hall", "presentation hall", "event hall", "big hall"],
  STUDY_SPACE: ["study area", "reading area", "study hall", "study room", "learning space", "reading room", "study zone"],
  VIBRATION_ROOM: ["vibration lab", "acoustics room", "isolation room", "testing chamber", "vibration chamber"],
  SOUND_BOOTH: ["recording booth", "recording studio", "vocal booth", "studio", "audio room", "music room", "podcast room"],
  QUIET_ROOM: ["silent room", "focus room", "no-talk zone", "silent zone", "concentration room", "meditation room", "calm room"],

  // Common areas
  CORRIDOR: ["hallway", "hall", "passage", "passageway", "walkway", "aisle", "gangway"],
  LOUNGE: ["common area", "common room", "social area", "break area", "seating area", "relaxation area", "chill area", "common space", "rec room"],
  KITCHEN: ["kitchenette", "break room", "coffee station", "tea room", "lunchroom", "food prep", "canteen kitchen"],
  CANTEEN: ["cafeteria", "food hall", "dining room", "restaurant", "cafe", "café", "eating area", "lunch room", "refectory", "mess hall"],
  ATRIUM: ["foyer", "open hall", "central hall", "glass hall", "light well", "inner courtyard"],
  RECEPTION: ["front desk", "lobby", "welcome desk", "entrance desk", "check-in", "visitor desk", "info desk", "information desk"],
  LIBRARY: ["book room", "reading room", "media center", "resource center", "knowledge center", "archive room"],
  FITNESS: ["gym", "exercise room", "workout room", "training room", "sports room", "weight room"],
  COVERED_AREA: ["sheltered area", "covered space", "canopy area", "roofed area", "outdoor shelter"],

  // Service & support
  TECHNICAL_ROOM: ["tech room", "mechanical room", "plant room", "utility room", "server room", "equipment room", "maintenance room"],
  STORAGE: ["stockroom", "store room", "supply room", "warehouse", "depot", "closet", "storeroom"],
  PRINT_ROOM: ["copy room", "printing room", "copier room", "print station", "reprographics", "document room"],
  CLOAKROOM: ["coat room", "wardrobe", "checkroom", "cloak area", "coat check", "hat check", "personal storage"],
  TOILET: ["restroom", "bathroom", "WC", "lavatory", "washroom", "loo", "facilities", "comfort room"],
  CHANGING_ROOM: ["locker room", "dressing room", "bathroom", "shower room", "bath area", "change room"],
  CLEANING_ROOM: ["janitor room", "janitorial closet", "cleaner's room", "housekeeping room", "mop room", "cleaning supplies"],
  IT_SUPPORT: ["helpdesk", "help desk", "tech support", "IT desk", "computer support", "technical support"],
  SERVICE_DESK: ["support desk", "customer service", "info desk", "help center", "assistance desk"],
  FACILITY_SUPPORT: ["facilities", "maintenance", "building services", "operations room", "facilities management"],
  LOADING_DOCK: ["delivery area", "goods in", "goods receiving", "unloading area", "freight dock", "loading bay", "dispatch area"],
  WASTE: ["trash room", "recycling room", "garbage room", "bin room", "sorting room", "waste management", "rubbish room"],

  // Infrastructure
  ELEVATOR: ["lift", "elevator shaft", "lift shaft", "accessible transport"],
  STAIRS: ["stairwell", "staircase", "steps", "fire stairs", "emergency stairs", "fire exit stairs"],
  VESTIBULE: ["anteroom", "antechamber", "entrance hall", "entry room", "lobby area", "transitional space", "waiting area"],
  SHAFT: ["duct shaft", "pipe shaft", "utility shaft", "service shaft", "vertical duct"],
  AIRLOCK: ["sluice", "clean room entry", "decontamination room", "pressure chamber", "transition chamber"],
