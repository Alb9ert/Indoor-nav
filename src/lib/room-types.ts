...
export const ROOM_TYPE_ALT: Record<RoomType, string[]> = {
  DEFAULT: ["general", "unspecified", "other", "misc", "miscellaneous", "unknown", "generel", "uspecificeret", "andet", "diverse", "ukendt"],

  // Workspace & education
  OFFICE: ["workspace", "desk area", "open plan", "workroom", "bullpen", "cubicle", "bureau", "kontor", "arbejdsplads", "skrivebordsområde", "åbent kontor", "arbejdsrum"],
  SEMINAR_ROOM: [
    "seminar",
    "classroom",
    "lecture room",
  ...
  // Common areas
  CORRIDOR: ["hallway", "hall", "passage", "passageway", "walkway", "aisle", "gangway", "korridor", "gang", "gangvej", "passage", "forgang"],
  LOUNGE: [
    "common area",
    "common room",
    "social area",
  ...
  ATRIUM: ["foyer", "open hall", "central hall", "glass hall", "light well", "inner courtyard", "atrium", "foyer", "åben hal", "centralhal", "glashal", "lysgård", "indre gård"],
  RECEPTION: [
    "front desk",
    "lobby",
    "welcome desk",
  ...
  FITNESS: ["gym", "exercise room", "workout room", "training room", "sports room", "weight room", "fitnesscenter", "motionsrum", "træningsrum", "sportsrum", "styrkerum", "motionscenter"],
  COVERED_AREA: [
    "sheltered area",
    "covered space",
    "canopy area",
  ...
  STORAGE: ["stockroom", "store room", "supply room", "warehouse", "depot", "closet", "storeroom", "lagerrum", "opbevaringsrum", "depot", "lager", "forsyningsrum", "skab"],
  PRINT_ROOM: [
    "copy room",
    "printing room",
    "copier room",
  ...
  SERVICE_DESK: ["support desk", "customer service", "info desk", "help center", "assistance desk", "serviceskranke", "kundeservice", "informationsskranke", "hjælpecenter", "assistanceskranke"],
  FACILITY_SUPPORT: [
    "facilities",
    "maintenance",
    "building services",
  ...
  // Infrastructure
  ELEVATOR: ["lift", "elevator shaft", "lift shaft", "accessible transport", "elevator", "lift", "elevatorskakt", "liftskakt", "handicapkøretøj"],
  STAIRS: [
    "stairwell",
    "staircase",
    "steps",
  ...
  SHAFT: ["duct shaft", "pipe shaft", "utility shaft", "service shaft", "vertical duct", "skakt", "ventilationsskakt", "rørskakt", "installationsskakt", "serviceskakt"],
  AIRLOCK: [
    "sluice",
    "clean room entry",
  ...
  RAMP: ["slope", "access ramp", "wheelchair ramp", "loading ramp", "incline", "rampe", "adgangsrampe", "kørestolsrampe", "lasteadgangsrampe", "hældning"],
}